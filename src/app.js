...
const loadOnline=async()=>{
 ...
 const [{MatchClient},{auth:authService},{AuthScreen},{MatchLobby}]=await Promise.all([
  import("./core/match-client.js?v=20260920-32"),import("./services/auth.js?v=20260920-36"),import("./modules/auth-screen/index.js?v=20260920-32"),import("./modules/match-lobby/index.js?v=20260920-32")
 ]);
