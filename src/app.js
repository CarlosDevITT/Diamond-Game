...
const loadOnline=async()=>{
 ...
 const [{MatchClient},{auth:authService},{AuthScreen},{MatchLobby}]=await Promise.all([
  import("./core/match-client.js?v=20260920-48"),import("./services/auth.js?v=20260924-58"),import("./modules/auth-screen/index.js?v=20260924-57"),import("./modules/match-lobby/index.js?v=20260920-39")
 ]);
