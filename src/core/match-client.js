...
export class MatchClient {
 #events; #room=null; #unsubscribe=null; #user=null; #matchUnsubscribe=null; #roomPoll=null; #heartbeat=null; #lastOpponentConnected=null; #disconnectTimer=null;
 ...
 leave(){const room=this.room;clearTimeout(this.#disconnectTimer);this.#disconnectTimer=null;clearInterval(this.#heartbeat);this.#heartbeat=null;this.#lastOpponentConnected=null;clearInterval(this.#roomPoll);this.#roomPoll=null;this.#unsubscribe?.();this.#matchUnsubscribe?.();this.#unsubscribe=null;this.#matchUnsubscribe=null;this.#room=null;this.#events.emit("match:left",room);}
