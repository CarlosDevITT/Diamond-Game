...
export class MatchClient {
 #events; #room=null; #unsubscribe=null; #user=null; #matchUnsubscribe=null; #gameUnsubscribe=null; #gameHandlers=new Set(); #seq=0; #lastGameSyncAt=0; #gameSyncBusy=false;
 ...
 leave(){const room=this.room;this.#unsubscribe?.();this.#matchUnsubscribe?.();this.#gameUnsubscribe?.();this.#unsubscribe=null;this.#matchUnsubscribe=null;this.#gameUnsubscribe=null;this.#gameHandlers.clear();this.#room=null;this.#events.emit("match:left",room);}
